...
- App Router: [GitHub](https://github.com/StackProviders/better-auth-nextjs-starter) - [Demo](https://nextjs.better-auth-starter.com)

- Pages Router: [GitHub](https://github.com/StackProviders/better-auth-nextjs-pages-starter) - [Demo](https://nextjs-pages.better-auth-starter.com)
...
import { authViewPaths } from "@/lib/auth/view-paths";
...
import { accountViewPaths } from "@/lib/auth/view-paths";
...
import { organizationViewPaths } from "@/lib/auth/view-paths";
...
Follow these steps to set up `better-auth-ui` in your [Next.js](https://nextjs.org) project using the **Pages Router**:
