...
This guide covers integrating `better-auth-ui` v3 with TanStack Start. We also install [better-auth-tanstack](https://github.com/StackProviders/better-auth-tanstack) to handle the authentication state and queries.

## Starter Project

Want to skip the installation? Check out the starter here:

[GitHub](https://github.com/StackProviders/better-auth-tanstack-starter) - [Demo](https://tanstack.better-auth-starter.com)
