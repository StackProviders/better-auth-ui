...
<Image
  alt="Update Avatar Card"
  src="/screenshots/update-avatar-card-dark.png"
  width={800}
  height={600}
...
<Image
  alt="Update Avatar Card"
  src="/screenshots/update-avatar-card-light.png"
  width={800}
  height={600}
...
```tsx
import { UpdateAvatarCard } from "better-auth-ui";
