...
```tsx
import { OrganizationSettingsCards } from "@/components/organization/organization-settings-cards";
...
<AutoTypeTable
  path="../src/components/organization/organization-settings-cards.tsx"
  name="OrganizationSettingsCardsProps"
/>
