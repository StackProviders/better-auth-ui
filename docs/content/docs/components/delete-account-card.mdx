...
<Image
  alt="Delete Account Card"
  src="/screenshots/delete-account-card-dark.png"
  width={800}
  height={600}
...
<Image
  alt="Delete Account Card"
  src="/screenshots/delete-account-card-light.png"
  width={800}
  height={600}
...
```tsx
import { DeleteAccountCard } from "better-auth-ui";
...
<AutoTypeTable
  path="../src/components/settings/account/delete-account-card.tsx"
  name="DeleteAccountCardProps"
/>
