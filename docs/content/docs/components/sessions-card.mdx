...
<Image
  alt="Sessions Card"
  src="/screenshots/sessions-card-dark.png"
  width={800}
  height={600}
...
<Image
  alt="Sessions Card"
  src="/screenshots/sessions-card-light.png"
  width={800}
  height={600}
...
```tsx
import { SessionsCard } from "better-auth-ui";
...
<SessionsCard
  localization={{
    ...
    SESSIONS_DESCRIPTION:
      "Review and revoke access from active devices and sessions.",
