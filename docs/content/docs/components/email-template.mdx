...
<Image
  alt="Email Template"
  src="/screenshots/email-template-dark.png"
  width={800}
  height={600}
  className="rounded-xl hidden dark:block w-sm mt-0 mb-0"
/>
<Image
  alt="Email Template"
  src="/screenshots/email-template-light.png"
  width={800}
  height={600}
  className="rounded-xl dark:hidden w-sm mt-0 mb-0"
/>
...
<AutoTypeTable
  path="../src/components/email/email-template.tsx"
  name="EmailTemplateProps"
/>
