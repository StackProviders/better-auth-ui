...
<ShadcnInstall name="change-password-card" />
...
```tsx
import { ChangePasswordCard } from "@/components/settings/security/change-password-card";
...
<ChangePasswordCard
  localization={{
    ...
    SET_PASSWORD_DESCRIPTION:
      "Add a password to your social account for easy future logins.",
