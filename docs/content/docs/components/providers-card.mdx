...
<Image
  alt="Providers Card"
  src="/screenshots/providers-card-dark.png"
  width={800}
  height={600}
...
<Image
  alt="Providers Card"
  src="/screenshots/providers-card-light.png"
  width={800}
  height={600}
...
<ShadcnInstall name="providers-card" />
...
```tsx
import { ProvidersCard } from "@/components/settings/providers/providers-card";
...
import { ProvidersCard, ChangeEmailCard, SettingsCards } from "better-auth-ui";
